      ...
      <div className="container footer-grid">
        <div className="footer-brand">
          ...
          <div className="footer-socials">
            ...
            <a href="#" className="social-btn">
              <svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2'><rect x='2' y='2' width='20' height='20' rx='5'/><circle cx='12' cy='12' r='4'/><circle cx='17.5' cy='6.5' r='1.5' fill='currentColor'/></svg>
            </a>
            <a href="#" className="social-btn">
              <svg width='18' height='18' viewBox='0 0 24 24' fill='currentColor'><path d='M22.54 6.42A2.78 2.78 0 0020.6 4.46C18.88 4 12 4 12 4s-6.88 0-8.6.46A2.78 2.78 0 001.46 6.42 29 29 0 001 12a29 29 0 00.46 5.58A2.78 2.78 0 003.4 19.54C5.12 20 12 20 12 20s6.88 0 8.6-.46a2.78 2.78 0 001.94-1.94A29 29 0 0023 12a29 29 0 00-.46-5.58zM9.75 15.02V8.98L15.5 12l-5.75 3.02z'/></svg>
            </a>
            <a href="#" className="social-btn">
